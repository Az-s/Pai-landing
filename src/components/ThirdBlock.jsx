    ...
    <div className="w-full  flex flex-col items-center my-[160px]">
      <div className="max-w-[1280px]">
        <div className="mx-2 sm:mx-0">
          <h4 className="text-[32px] sm:text-[48px] font-bold">
        ...
        <div className="flex justify-center flex-wrap gap-[24px] mx-3 sm:mx-0">
          {fourthBlockCardsInfo.map((card, index) => (
            <div
              ...
              className={` ${
                index === 3
                  ? "bg-[#ff4432] w-full sm:w-[680px] h-[440px] sm:h-[328px] rounded-3xl border-[2px] text-left p-[40px]"
                  : "border-[2px] border-[#E9E9E9] rounded-3xl w-full sm:w-[328px] h-[240px] sm:h-[328px] text-left p-[40px]"
              }`}
            >
              <h5
                className={`${
                  index === 3
                    ? "bg-[#ff4432] text-white text-[32px] sm:text-[40px] font-semibold"
                    : `text-[32px] sm:text-[40px] text-[#ff4432] font-semibold`
                }`}
              >
                {card.title}
              </h5>
              ...
              {card.img && (
                <img
                  src={card.img}
                  alt={card.title}
                  className="h-[284px] sm:h-[229px] w-[288px] sm:w-[180px] ml-5 mt-[10px] sm:mt-[-40px]"
