  ...
  return (
    <div className="bg-black text-white py-[160px] w-full  flex flex-col items-center">
      <div className="max-w-[1280px]">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-around sm:justify-between text-left border-[1px] border-[#191919] rounded-3xl bg-[#191919] h-[400px] sm:h-[328px] px-[80px] mx-3 sm:mx-0">
          <div className="sm:w-1/2 flex items-center justify-center order-2 sm:order-1">
            <img src={firstBlockImg} alt="" className="max-h-full w-[300px] sm:max-w-full" />
          </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-around sm:justify-between text-left border-[1px] border-[#191919] rounded-3xl bg-[#191919] h-[328px] my-[24px] px-[80px] mx-3 sm:mx-0">
          ...
          <div className="sm:w-1/2 flex items-center justify-center">
            <img
              src={secondBlockImg}
              alt=""
              className="max-h-full w-[300px] sm:max-w-full" 
            />
          </div>
        </div>
        <div className="flex flex-col sm:flex-row items-center justify-around sm:justify-between text-left border-[1px] border-[#191919] rounded-3xl bg-[#191919] h-[328px] px-[80px] mx-3 sm:mx-0">
          <div className="sm:w-1/2 flex items-center justify-center order-2 sm:order-1">
            <img src={thirdBlockImg} alt="" className="max-h-full w-[300px] sm:max-w-full" />
          </div>
          <div className="sm:w-1/2 order-1 sm:order-2">
        ...
        <div className="flex justify-center flex-col sm:flex-row gap-[24px] mt-[24px] mx-3 sm:mx-0">
          {secondBlockCardsInfo.map((card) => (
            ...
            >
              <h5 className="text-[28px] sm:text-[32px]">{card.title}</h5>
